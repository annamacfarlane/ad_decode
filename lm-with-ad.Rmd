...
plot4 <- ggplot(geno_combined, aes(age, AVLT_Trial7, 
                                   color = Genotype, fill = Genotype)) + 
  geom_point(aes(shape = Risk)) + 
  facet_grid(. ~ sex) + 
  stat_smooth(method = "lm", alpha = 0.2) +
...
plot4 <- ggplot(geno_combined, aes(age, Composite_Pleasantness, 
                                   color = Genotype, fill = Genotype)) + 
  geom_point(aes(shape = Risk)) + 
  facet_grid(. ~ sex) + 
  stat_smooth(method = "lm", alpha = 0.2) +
...
plot4 <- ggplot(geno_combined, aes(age, Composite_Intensity, 
                                   color = Genotype, fill = Genotype)) + 
  geom_point(aes(shape = Risk)) + 
  facet_grid(. ~ sex) + 
  stat_smooth(method = "lm", alpha = 0.2) +
...
plot4 <- ggplot(geno_combined, aes(age, Composite_Familiarity, 
                                   color = Genotype, fill = Genotype)) + 
  geom_point(aes(shape = Risk)) + 
  facet_grid(. ~ sex) + 
  stat_smooth(method = "lm", alpha = 0.2) +
...
plot4 <- ggplot(geno_combined, aes(age, Composite_Nameability, 
                                   color = Genotype, fill = Genotype)) + 
  geom_point(aes(shape = Risk)) + 
  facet_grid(. ~ sex) + 
  stat_smooth(method = "lm", alpha = 0.2) +
...
plot1<-ggplot(geno_combined, aes(x = age, y = Delayed_verbatim,
  ...
  annotate("point", x = data$age[23], y = data$ufov1[23], colour = "darkgreen", shape = 9) +
  annotate("point", x = data$age[54], y = data$ufov1[54], colour = "darkgreen", shape = 9) +
  annotate("point", x = data$age[54], y = data$ufov1[56], colour = "darkgreen", shape = 9) +
  annotate("point", x = data$age[54], y = data$ufov1[58], colour = "darkgreen", shape = 9)
