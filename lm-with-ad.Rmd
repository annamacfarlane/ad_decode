...
imravlt_lm2 <- lm(AVLT_Trial7 ~ age*Genotype*sex, geno_combined)
summary(imravlt_lm2)

imravlt_lm_f <- lm(AVLT_Trial7 ~ age*Genotype, combo_f)
summary(imravlt_lm_f)

imravlt_lm_m <- lm(AVLT_Trial7 ~ age*Genotype, combo_m)
summary(imravlt_lm_m)
